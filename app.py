...
if __name__ == '__main__':
    # Obtener el puerto de la variable de entorno PORT, default a 5000 si no existe
    port = int(os.environ.get('PORT', 5000))
    # Escuchar en todas las interfaces (0.0.0.0) y en el puerto asignado por Render
    app.run(host='0.0.0.0', port=port, debug=False) # Asegúrate de importar 'os' al inicio del archivo (import os) y poner debug=False para producción